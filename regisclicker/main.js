...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu=='log')
			{
				...
				'<div class="subsection">'+
				'<div class="title">REGIS pls</div>'+
				'<div class="listing">notice me senpai</div>'+
				'</div>'
				;
			}
			else if (Game.onMenu=='stats')
			{
				...
				'<div class="subsection">'+
				'<div class="title">General</div>'+
				'<div class="listing"><b>Clicks sent :</b> <div class="price plain">'+Beautify(Game.cookies)+'</div></div>'+
				'<div class="listing"><b>Clicks sent (all time) :</b> <div class="price plain">'+Beautify(Game.cookiesEarned)+'</div></div>'+
				...
				'<div class="listing"><b>Clicks per second :</b> '+Beautify(Game.cookiesPs,1)+' <small>(multiplier : '+Beautify(Math.round(Game.globalCpsMult*100),1)+'%)</small></div>'+
				'<div class="listing"><b>Clicks per mouseclick :</b> '+Beautify(Game.computedMouseCps,1)+'</div>'+
				'<div class="listing"><b>REGIS clicks :</b> '+Beautify(Game.cookieClicks)+'</div>'+
				'<div class="listing"><b>Clicked by hand :</b> '+Beautify(Game.handmadeCookies)+'</div>'+
	...
	Game.Logic=function()
	{
		...
		if (Game.T%(Game.fps)==0) document.title=Beautify(Game.cookies)+' '+(Game.cookies==1?'click':'clicks')+' - REGIS Clicker';
	...
	Game.Draw=function()
	{
		...
		var unit=(Math.round(Game.cookiesd)==1?' desperate click':' desperate clicks');
